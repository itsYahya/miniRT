...
How can we make it do better ?. We can use multi-threading, instead of doing the whole image at once we can divide it to multiple threads, and that will make our program run a little faster.
